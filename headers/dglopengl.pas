...
{$IFDEF DARWIN}
const
  // OpenGL.framework is always installed on any macs
...
{$ELSE}
  {$IFDEF DARWIN}
    function InitOpenGL(LibName: string = libPath + 'libGL.dylib'; GLULibName: string = libPath + 'libGLU.dylib'): Boolean;
  {$ELSE}
