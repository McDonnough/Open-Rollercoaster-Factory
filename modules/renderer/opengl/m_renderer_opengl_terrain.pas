...
begin
  ...
  fBoundShader.Bind;
  fBoundShader.UniformF('ShadowQuadA', ModuleManager.ModRenderer.ShadowQuad[0].X, ModuleManager.ModRenderer.ShadowQuad[0].Y, ModuleManager.ModRenderer.ShadowQuad[0].Z);
  fBoundShader.UniformF('ShadowQuadB', ModuleManager.ModRenderer.ShadowQuad[1].X, ModuleManager.ModRenderer.ShadowQuad[1].Y, ModuleManager.ModRenderer.ShadowQuad[1].Z);
  fBoundShader.UniformF('ShadowQuadC', ModuleManager.ModRenderer.ShadowQuad[2].X, ModuleManager.ModRenderer.ShadowQuad[2].Y, ModuleManager.ModRenderer.ShadowQuad[2].Z);
  fBoundShader.UniformF('ShadowQuadD', ModuleManager.ModRenderer.ShadowQuad[3].X, ModuleManager.ModRenderer.ShadowQuad[3].Y, ModuleManager.ModRenderer.ShadowQuad[3].Z);
