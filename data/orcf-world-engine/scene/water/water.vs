...
void main(void) {
  ...
  Displacement = bumpColor.a * gl_Vertex.z * 0.4 * hm;
  gl_Position = gl_ModelViewProjectionMatrix * vec4(gl_Vertex.x + Offset.x, Height + Displacement, gl_Vertex.y + Offset.y, 1.0);
}
