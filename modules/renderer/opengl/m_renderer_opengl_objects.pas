...
begin
  ...
  for i := 0 to fTriangles - 1 do
    for j := 0 to 2 do
      ...
      fVBO.Colors[3 * i + j] := Vector(fMesh.Vertices[fMesh.Triangles[i][j]].BumpTexCoord, 0.0, 1.0); // Last two coordinates have no function yet
...
begin
  ...
  for i := 0 to high(O.fManagedMeshes) do
    ...
    MakeOGLCompatibleMatrix(O.fManagedMeshes[i].fMesh.StaticRotationMatrix * O.fManagedMeshes[i].fMesh.RotationMatrix, @Matrix[0]);
    fBoundShader.UniformF('Position', O.fManagedMeshes[i].fMesh.StaticOffset.X + O.fManagedMeshes[i].fMesh.Offset.X, O.fManagedMeshes[i].fMesh.StaticOffset.Y + O.fManagedMeshes[i].fMesh.Offset.Y, O.fManagedMeshes[i].fMesh.StaticOffset.Z + O.fManagedMeshes[i].fMesh.Offset.Z);
    fBoundShader.UniformMatrix3D('Rotation', @Matrix[0]);
...
begin
  ...
  with fTest.AddMesh do
    begin
    Vertices[0] := MakeExtendedMeshVertex(Vector(0, 0, 0), Vector(0, -1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[1] := MakeExtendedMeshVertex(Vector(5, 0, 0), Vector(0, -1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[2] := MakeExtendedMeshVertex(Vector(5, 0, 5), Vector(0, -1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[3] := MakeExtendedMeshVertex(Vector(0, 0, 5), Vector(0, -1, 0), Vector(0, 0), Vector(0, 0));

    Vertices[4] := MakeExtendedMeshVertex(Vector(0, 5, 5), Vector(0, 1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[5] := MakeExtendedMeshVertex(Vector(5, 5, 5), Vector(0, 1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[6] := MakeExtendedMeshVertex(Vector(5, 5, 0), Vector(0, 1, 0), Vector(0, 0), Vector(0, 0));
    Vertices[7] := MakeExtendedMeshVertex(Vector(0, 5, 0), Vector(0, 1, 0), Vector(0, 0), Vector(0, 0));

    Vertices[8] := MakeExtendedMeshVertex(Vector(0, 0, 5), Vector(-1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[9] := MakeExtendedMeshVertex(Vector(0, 5, 5), Vector(-1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[10] := MakeExtendedMeshVertex(Vector(0, 5, 0), Vector(-1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[11] := MakeExtendedMeshVertex(Vector(0, 0, 0), Vector(-1, 0, 0), Vector(0, 0), Vector(0, 0));

    Vertices[12] := MakeExtendedMeshVertex(Vector(5, 0, 0), Vector(1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[13] := MakeExtendedMeshVertex(Vector(5, 5, 0), Vector(1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[14] := MakeExtendedMeshVertex(Vector(5, 5, 5), Vector(1, 0, 0), Vector(0, 0), Vector(0, 0));
    Vertices[15] := MakeExtendedMeshVertex(Vector(5, 0, 5), Vector(1, 0, 0), Vector(0, 0), Vector(0, 0));

    Vertices[16] := MakeExtendedMeshVertex(Vector(0, 0, 0), Vector(0, 0, -1), Vector(0, 0), Vector(0, 0));
    Vertices[17] := MakeExtendedMeshVertex(Vector(0, 5, 0), Vector(0, 0, -1), Vector(0, 0), Vector(0, 0));
    Vertices[18] := MakeExtendedMeshVertex(Vector(5, 5, 0), Vector(0, 0, -1), Vector(0, 0), Vector(0, 0));
    Vertices[19] := MakeExtendedMeshVertex(Vector(5, 0, 0), Vector(0, 0, -1), Vector(0, 0), Vector(0, 0));

    Vertices[20] := MakeExtendedMeshVertex(Vector(5, 0, 5), Vector(1, 0, 1), Vector(0, 0), Vector(0, 0));
    Vertices[21] := MakeExtendedMeshVertex(Vector(5, 5, 5), Vector(1, 0, 1), Vector(0, 0), Vector(0, 0));
    Vertices[22] := MakeExtendedMeshVertex(Vector(0, 5, 5), Vector(1, 0, 1), Vector(0, 0), Vector(0, 0));
    Vertices[23] := MakeExtendedMeshVertex(Vector(0, 0, 5), Vector(1, 0, 1), Vector(0, 0), Vector(0, 0));
