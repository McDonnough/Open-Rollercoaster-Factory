...
begin
  ...
  fSun.AmbientColor := Vector(0.05, 0.05, 0.05, 0.0) + Vector(0.2, 0.25, 0.32, 0.0) * Clamp(2 * fSun.Position.Y, 0, 1) + Vector(0.02, 0.04, 0.1, 0.0) * Clamp(-2 * fSun.Position.Y, 0, 1);
  fSun.Color := Vector(1.0, 0.95, 0.88, 1);
  fSun.Color := fSun.Color * Clamp(1.4 * fSun.Position.Y, 0, 1);
  fSun.Color.Y := fSun.Color.Y * Clamp(0.6 + 0.6 * fSun.Position.Y, 0, 1);
  fSun.Color.Z := fSun.Color.Z * Clamp(0.4 + 0.9 * fSun.Position.Y, 0, 1);
  fSun.Color := fSun.Color + Vector(0.02, 0.04, 0.1, 0.0) * Clamp(-2 * fSun.Position.Y, 0, 1);
  fSun.Position := fSun.Position * 1000000;
