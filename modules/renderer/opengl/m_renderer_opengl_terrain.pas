      ...
      for j := 0 to l - 1 do
        ...
        if (i >= m) or (j >= n) then
          ...
          for o := 0 to 63 do
            for p := 0 to 63 do
              begin
              fVBOs[i, j].Vertices[4 * (64 * o + p) + 0] := Vector(0.8 * 64 * i + 0.8 * o + 0.0, 10, 0.8 * 64 * j + 0.8 * p + 0.0);
              fVBOs[i, j].Vertices[4 * (64 * o + p) + 1] := Vector(0.8 * 64 * i + 0.8 * o + 0.8, 10, 0.8 * 64 * j + 0.8 * p + 0.0);
              fVBOs[i, j].Vertices[4 * (64 * o + p) + 2] := Vector(0.8 * 64 * i + 0.8 * o + 0.8, 10, 0.8 * 64 * j + 0.8 * p + 0.8);
              fVBOs[i, j].Vertices[4 * (64 * o + p) + 3] := Vector(0.8 * 64 * i + 0.8 * o + 0.0, 10, 0.8 * 64 * j + 0.8 * p + 0.8);
              end;
          fVBOs[i, j].UnBind;
          ...
          for o := 0 to 15 do
            for p := 0 to 15 do
              begin
              fRawVBOs[i, j].Vertices[4 * (16 * o + p) + 0] := Vector(0.8 * 64 * i + 3.2 * o + 0.0, 10, 0.8 * 64 * j + 3.2 * p + 0.0);
              fRawVBOs[i, j].Vertices[4 * (16 * o + p) + 1] := Vector(0.8 * 64 * i + 3.2 * o + 3.2, 10, 0.8 * 64 * j + 3.2 * p + 0.0);
              fRawVBOs[i, j].Vertices[4 * (16 * o + p) + 2] := Vector(0.8 * 64 * i + 3.2 * o + 3.2, 10, 0.8 * 64 * j + 3.2 * p + 3.2);
              fRawVBOs[i, j].Vertices[4 * (16 * o + p) + 3] := Vector(0.8 * 64 * i + 3.2 * o + 0.0, 10, 0.8 * 64 * j + 3.2 * p + 3.2);
              end;
          fRawVBOs[i, j].UnBind;
          end;
        end;
