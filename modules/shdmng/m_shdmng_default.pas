...
type
  ...
  TModuleShaderManagerDefault = class(TModuleShaderManagerClass)
    ...
    public
      ...
      function LoadShader(VSFile, FSFile: String; GSFile: String = ''; VerticesOut: Integer = 0; InType: GLEnum = GL_TRIANGLES; OutType: GLEnum = GL_TRIANGLE_STRIP): Integer;
...
function TModuleShaderManagerDefault.LoadShader(VSFile, FSFile: String; GSFile: String = ''; VerticesOut: Integer = 0; InType: GLEnum = GL_TRIANGLES; OutType: GLEnum = GL_TRIANGLE_STRIP): Integer;
...
begin
  ...
  if GSFile <> '' then
    ...
    glProgramParameteriEXT(fShdRef[Result].ID, GL_GEOMETRY_INPUT_TYPE_EXT, InType);
    glProgramParameteriEXT(fShdRef[Result].ID, GL_GEOMETRY_OUTPUT_TYPE_EXT, OutType);
    end;
